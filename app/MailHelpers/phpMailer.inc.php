...
class phpMailer {
	...
	function _smtp_send(){
		if ($this->_open_smtp_conn()){
			...
			$result = $this->_extract_email($this->mail_from);
			if (!$this->_send_smtp_command("MAIL FROM: {$result}", array(220, 250, 354))){return FALSE;}
