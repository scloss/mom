...
<body style="">
	...
	<footer class="footer">
      <div class="footDiv">
        <h5>SCL MOM TOOL v1.1 © 2016 SCL NOC-OSS | All rights reserved | Summit Communications Ltd.</h5>
      </div>
    </footer>
	<!-- <footer>	
		<div id="footer" >
			<h5>©2015 SCL NOC | All rights reserved | Summit Communications Ltd.</h5>
		</div>
	</footer> -->
