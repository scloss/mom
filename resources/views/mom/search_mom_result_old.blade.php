		...
		<div class="container-fluid">
						...
						<div id="meetingDiv" class="col-md-6">
							<table class="meetingTable">
								...
								<tr>
			        				...
			        				<td><input type="Text" name="meeting_datetime1" id="meeting_datetime1" value="{{$current_date}}"  maxlength="25" size="25"/>
			        				<img src="{{ asset('/js/images/cal.gif') }}" onclick="javascript:NewCssCal ('meeting_datetime1','yyyyMMdd','dropdown',true,'24',true);" style="cursor:pointer;float:right"/></td>
								</tr>
								<tr>
									<td>Meeting Time To: </td>
			        				<td><input type="Text" name="meeting_datetime2" id="meeting_datetime2" value="{{$current_date}}"  maxlength="25" size="25"/>
								...
								<tr>
									<td>Meeting Attendee: </td><td>{!! Form::text('search_meeting_attendee') !!}</td>
								</tr>
								<tr>
									<td>Mail Recipient: </td><td>{!! Form::text('search_mail_recipient') !!}</td>
								</tr>
								<tr>
									<td>Meeting type : </td><td>{!! Form::text('search_meeting_type') !!}</td>
								</tr>
								<tr>
									<td>Meeting status :</td> <td>{!! Form::text('search_meeting_status') !!}</td>
								</tr>
								<tr>
									<td colspan='2' style="text-align:right;">{!! Form::submit('search' , array('class'=>'btn')); !!}</td>
								</tr>
							...
							<table class="meetingTable">
								<tr>
									<td>MoM Title:	</td><td>{!! Form::text('search_mom_title') !!}</td>
								</tr>
								<tr>
									<td>Responsible: </td><td> {!! Form::text('search_responsible') !!}</td>
								</tr>
								<tr style="background-color:#D6D6D8;">
									<td colspan='2'>
								...
								<tr>
			        				...
			        				<td><input type="Text" name="search_mom_start_time1" id="search_mom_start_time1" maxlength="25" size="25"/>
								...
								<tr>
			        				...
			        				<td><input type="Text" name="search_mom_start_time2" id="search_mom_start_time2" maxlength="25" size="25"/>
								...
								<tr>
			        				...
			        				<td><input type="Text" name="search_mom_end_time1" id="search_mom_end_time1" maxlength="25" size="25"/>
								...
								<tr>
			        				...
			        				<td><input type="Text" name="search_mom_end_tim2e" id="search_mom_end_time2" maxlength="25" size="25"/>
								...
								<tr>
									<td>MoM Status:</td>	<td>{!! Form::text('search_mom_status') !!}</td>
								</tr>
							</table>
							<br>
				{!! Form::close() !!}
			...
			<div style="margin-top:5%;">
				...
				<tr class="trHeader">
						...
						<!-- <td>Mom Status</td> --> <td>Mother Meeting Id</td><td>View</td> <td class="noExl">Edit</td><!-- <td>MoM Comment</td> --><td class="noExl">Create Follow Up Meeting</td>
					</tr>
