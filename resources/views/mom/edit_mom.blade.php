		...
		function emailfunction(id,value){
		  ...
		  if(value == 'submit'){
			...
			//alert(emailStr);
		  	...
		  	document.getElementById("to_list").value = emailStr;
		  	//alert(emailValues);
			...
			<div class="content">
				...
				<!-- {!! Form::open(array('url' => 'editProcess', 'method' => 'GET','class'=>'meetingForm','id' => 'meetingForm')) !!} -->
					...
					<!-- <?php echo $mom_table_list->mom_completion_status; ?> -->
						...
						@if($is_meeting_status_closed == 'closed')
								<td id="DisableHeader" >	
									{!! Form::textarea($mom_title,$mom_table_list->mom_title, array('class'=>'inputTitle','id'=>$mom_title,'readonly', 'rows' => 3, 'cols' => 20)) !!}
								</td>
								<td id="DisableHeader" >
							...
							<td id="DisableHeader">
									{!! Form::select('mom_status_select', $meeting_status_drop,$mom_table_list->mom_status, array('class'=>'demoClass','readonly')) !!}
									{!! Form::hidden($mom_status, $mom_table_list->mom_status) !!}
									</td>
									<td id="DisableHeader">
									{!! Form::select($mom_completion_status, $mom_completion_status_drop,$mom_table_list->mom_completion_status, array('class'=>'demoClass','readonly')) !!}
									...
									<td id="DisableHeader">
										<textarea name="<?php echo $mom_comment; ?>" readonly cols="20" rows="2" id="commentArea" style="vertical-align:middle;color:#000 !important;background:#D4CDCD !important;"><?php echo stripslashes($mom_table_list->comment); ?></textarea>
									</td>	

						@else
							@if($is_organizer == true)
								<td id="DisableHeader" style="input[type="text"]{width:88% !important;} ">	
									{!! Form::textarea($mom_title,$mom_table_list->mom_title, array('class'=>'inputTitle','id'=>$mom_title,'readonly', 'rows' => 3, 'cols' => 20)) !!}
								</td>
								<td id="DisableHeader">

									<a href="Javascript:testScript('{{$responsible}}')">{!! Form::textarea($responsible,$mom_table_list->responsible, array('class'=>'inputTitle','id'=>$responsible, 'rows' => 3, 'cols' => 20,'readonly')) !!}
									</a>
								</td>
								<td id="DisableHeader">
								...
								<td id="DisableHeader">
		        					...
		        					<img src="{{ asset('/js/images/cal.gif') }}" onclick=""/>
								</td>
								...
								<td id="{{$headerId}}">
		        					...
		        					<img src="{{ asset('/js/images/cal.gif') }}" onclick="javascript:NewCssCal ('<?php echo $mom_completion_time; ?>','yyyyMMdd','dropdown',true,'24',true);" />
								</td>
								
								<td id="{{$headerId}}">
									<textarea name="prevComment" cols="25" rows="2" id="commentArea" readonly style="vertical-align:middle;color:#000 !important;background:#D4CDCD !important;"><?php echo stripslashes($mom_table_list->comment); ?></textarea><br>
							...
							@else
								...
								<?php if (strpos($mom_table_list->responsible, $matchStr ) !== false){?>
									...
									<td id="EnableHeader">
										<textarea name="prevComment" cols="20" rows="2" id="commentArea" readonly placeholder="Please type new comment here" style="vertical-align:middle;color:#000 !important;"><?php echo stripslashes($mom_table_list->comment); ?></textarea>
								...
								<?php }
									...
									<td id="DisableHeader">
										<textarea name="<?php echo $mom_comment; ?>" disabled cols="20" rows="2" id="commentArea" style="vertical-align:middle;color:#000 !important;"><?php echo stripslashes($mom_table_list->comment); ?></textarea>
									</td>
								<?php } ?>
