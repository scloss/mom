		...
		<div class="container-fluid">
								...
								<tr>
									<td colspan='2' style="text-align:right;">
										<b>View Mode  :  </b>Meeting 
											...
											<br>{!! Form::checkbox('searchForExport', 'yes') !!} Search For Export {!! Form::submit('search' , array('class'=>'editBtn')); !!}</td>
								</tr>
			...
			<div style="margin-top:5%;">
				...
				<tr class="trHeader">
						...
						@endif
						@if($view_mode=='momView')
						<td>MOM ID</td><td>MOM Title</td><td>MOM Responsible</td><td>MOM Start Time</td><td>MOM End Time</td><td>MOM Status</td><td>MOM Completion Status</td><td>MOM Comment</td>
						@endif
				...
				@foreach($items as $item)
					<tr>
						...
						<td>
							<div style="width:250px;word-wrap: break-word;white-space: pre-line">
							{{$item->comment}}
							</div>
						</td>
